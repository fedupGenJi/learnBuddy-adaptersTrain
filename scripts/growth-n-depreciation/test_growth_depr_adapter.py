...
ADAPTER = "adapters/growth_depr_v1"
...
def main():
    print("Loading base model + growth/depreciation adapter...")
    ...
    # -----------------------
    prompt_mcq = """SYSTEM:
You are an NEB Grade 10 Mathematics question generator for the chapter Growth and Depreciation.
...
"""
    ...
    # Test 2: solve
    # -----------------------
    sample_q = "The population of a city is 20,000 and it grows at 5% per annum for 2 years. Find the population after 2 years."

    prompt_solve = f"""SYSTEM:
You are an NEB Grade 10 Mathematics tutor for the chapter Growth and Depreciation.
