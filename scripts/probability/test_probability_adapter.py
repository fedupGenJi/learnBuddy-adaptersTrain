...
ADAPTER = "adapters/probability_v1"
...
def main():
    print("Loading base model + probability adapter...")
    ...
    # -----------------------
    prompt_mcq = """SYSTEM:
You are an NEB Grade 10 Mathematics question generator for the chapter Probability.
...
"""
    ...
    # Test 2: solve
    # -----------------------
    sample_q = "A bag contains 5 red and 3 blue balls. Two balls are drawn without replacement. Find the probability that both are red."

    prompt_solve = f"""SYSTEM:
You are an NEB Grade 10 Mathematics tutor for the chapter Probability.
