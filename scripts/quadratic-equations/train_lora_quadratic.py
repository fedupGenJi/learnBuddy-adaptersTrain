...
TRAIN_FILE = "data/quadratic/processed/train.jsonl"  # <- quadratic dataset
ADAPTER_OUT = "adapters/quadratic_v1"
...
def tokenize_fn(batch):
    out = tokenizer(
        batch["text"],   # quadratic dataset must contain "text" field
        truncation=True,
        max_length=MAX_LEN,
        padding=False,
    )
