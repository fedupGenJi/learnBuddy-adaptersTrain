...
ADAPTER = "adapters/sequence_series_v1"
...
def main():
    print("Loading base model + sequence & series adapter...")
    ...
    prompt_mcq = """SYSTEM:
You are an NEB Grade 10 Mathematics question generator for the chapter Sequence and Series.
...
Difficulty: 2
Rules:
- Create ONE NEB-style word problem from arithmetic or geometric series.
...
"""
    ...
    sample_q = "Find the sum of first 10 terms of an arithmetic series with first term 3 and common difference 5."

    prompt_solve = f"""SYSTEM:
You are an NEB Grade 10 Mathematics tutor for the chapter Sequence and Series.
